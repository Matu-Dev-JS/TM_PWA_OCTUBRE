...
app.get('/products', (req, response) => {
    ...
    if(min_price){
        productos_filtrados = productos_filtrados.filter(producto => producto.price >= min_price)
    }
    if(max_price){
        productos_filtrados = productos_filtrados.filter(producto => producto.price <= max_price)
    }
